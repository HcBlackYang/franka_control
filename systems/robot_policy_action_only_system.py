...
class RobotPolicySystem:
    def __init__(self, action_space: ActionSpace = ActionSpace.JOINT_ANGLES, ip: str = "10.21.40.5", port: str = "8003", camera_calib_file: str = "/home/dell/maple_control/data/20250829_fruits_and_tray/20250829_173310"):
        # 初始化机器人环境
