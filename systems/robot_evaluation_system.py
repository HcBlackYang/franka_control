...
class RobotEvaluationSystem:
    def __init__(self, save_dir: str = "./data/evaluation/0906_pickup_bottle_200epi_160k", action_space: ActionSpace = ActionSpace.EEF_VELOCITY, action_only_mode: bool = False, calibration: bool=True):
        self.policy_system = RobotPolicySystem(action_space=action_space, action_only_mode=action_only_mode, calibration=calibration)
