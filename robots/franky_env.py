...
class FrankyEnv(RobotEnv):
    def __init__(self, robot_ip: str = "172.16.0.2",
                ...
                #  initial_position: np.ndarray = np.array([-0.000015, 0.139870, 0.000054, -1.091424, -0.000561, 1.256351, 0.784893]),
                # initial_position: np.ndarray = np.array([ -5.87450480e-04,  1.72760554e-02, -3.26427155e-04 ,-2.05170391e+00, -7.94322444e-04,  2.08370469e+00,  7.85595824e-01]),
                 robot_param = None,
