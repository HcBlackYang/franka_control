...
DATA_SAVE_PATH = "./data/pick_up_the_paper_cup"
...
def calibrate_cameras():
    ...
    try:
        ...
        return jsonify({'status': 'error', 'message': f'重置失败: {str(e)}'})
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=5001, debug=False) # host='0.0.0.0' 允许外部访问